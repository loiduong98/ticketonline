                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/khachhang/sua/{{$khachhang->id}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="GioiTinh" id="GioiTinh" value="{{$khachhang->GioiTinh}}">                                   
                            ...
                            <div class="form-group">
                                <label>Địa chỉ</label>
                                <input class="form-control" name="DiaChi" placeholder="Nhập địa chỉ" value="{{$khachhang->DiaChi}}"/>
                            </div>
                            <div class="form-group">
                                <label>Số điện thoại</label>
                                <input class="form-control" name="SDT" placeholder="Nhập SDT" value="{{$khachhang->SDT}}"/>
                            </div>
                            <div class="form-group">
                                <label>Ghi chú</label>
                                <textarea id="demo" class="form-control ckeditor" rows="3" name="GhiChu">{{$khachhang->GhiChu}}</textarea>
                            </div>
