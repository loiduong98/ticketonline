        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-ms-12">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel">
                            <table class="table ">
                                <form class="form w-50 mr-15" method="POST" action="page/checkout/1" enctype="multipart/form-data>
                                <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-ms-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <i class="fa fa-bus text-primary"></i>
                                                    <select name="idBenDen" id="idBenDen" class="form-control selectpicker bs-select-hideden">
                                                        <option value="CANTHO">Cần Thơ</option>
                                                        <option value="TPHCM">TP Hồ Chí Minh</option>
                                                        <option value="DALAT">Đà Lạt</option>
                                                    </select>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-ms-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input id="NgayKhoiHanh" name="NgayKhoiHanh" placeholder="dd/mm/yyyy" class="form-control dDate date-readonly " type="date">
                                                    <small>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-ms-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <select name="GioKhoiHanh" id="GioKhoiHanh" class="form-control selectpicker bs-select-hideden">
                                                        <option value="8h00">8h00</option>
                                                        <option value="3h00">3h00</option>
                                                        <option value="22h00">22h00</option>
                                                    </select>
                                                    <input name="idBenDi" type="hidden" value="secret">
                                                    <input name="idBenDen" type="hidden" value="secret">
                                                    <input name="NgayKhoiHanh" type="hidden" value="secret">
                                                    <input name="GioKhoiHanh" type="hidden" value="secret">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-ms-12">
                                            ...
                                            <button><a href="page/checkout/2" ng-click="prev()" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right icon-flat bg-btn-actived"></i> Tiếp Tục</a></button>
                ...
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 col-ms-12 pt-1">
                    <img src="master-asset/img/Thong-cao-Khai-Truong-Phan-Rang-BXMĐ.png" alt="">
                </div>
            </div>
        </div>
    </section>
