...
(function(I, d, B) {
    ...
    function D(f, q) {
        q = q || {};
        d.forEach(q, function(d, h) { delete q[h] });
    ...
    d.module("ngResource", ["ng"]).provider("$resource", function() {
        ...
        this.$get = ["$http", "$q", function(q, h) {
            ...
            function w(y, g, l, m) {
                ...
                function F(b) { return b.resource }
                ...
                r(l, function(b, k) {
                    ...
                    e[k] = function(a, z, m, y) {
                        ...
                        r(b, function(b, a) { "params" != a && "isArray" != a && "interceptor" != a && (t[a] = H(b)) });
                        g && (t.data = f);
                        ...
                        n = q(t).then(function(a) {
                            ...
                            if (c) {
                                ...
                                b.isArray ? (p.length = 0, r(c, function(a) { "object" === typeof a ? p.push(new e(a)) : p.push(a) })) :
                                    (D(c, p), p.$promise = g)
                            }
                            p.$resolved = !0;
                            a.resource = p;
                ...
                e.bind = function(b) { return w(y, s({}, g, b), l) };
                return e
            }
            var E = d.noop,
                r = d.forEach,
            ...
            u.prototype = {
                setUrlParams: function(f, g, l) {
                    var m = this,
                        c = l || m.template,
                        h, e, q = m.urlParams = {};
                    r(c.split(/\W/), function(b) { if ("hasOwnProperty" === b) throw x("badname");! /^\d+$/.test(b) && b && (new RegExp("(^|[^\\\\]):" + b + "(\\W|$)")).test(c) && (q[b] = !0) });
                    c = c.replace(/\\:/g, ":");
                    g = g || {};
                    ...
                    c = c.replace(/\/\.(?=\w+($|\?))/, ".");
                    f.url = c.replace(/\/\\\./, "/.");
                    r(g, function(b, c) { m.urlParams[c] || (f.params = f.params || {}, f.params[c] = b) })
                }
            };
            return w
        }]
